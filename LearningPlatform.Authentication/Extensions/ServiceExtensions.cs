using LearningPlatform.Authentication.Handlers;
using LearningPlatform.Authentication.Options;
using LearningPlatform.Authentication.Services;
using LearningPlatform.Database;
...
public static class ServiceExtensions
{
    public static void AddAppAuthentication(this IServiceCollection services, IConfigurationRoot configuration)
    {
        ...
        services.AddIdentity<UserDb, IdentityRole>(options => 
            ...
            .AddEntityFrameworkStores<LearningPlatformContext>()
